...
public class TC09_ToverifyCreatedActivityToBeEditedTest extends TestBase {
	...
	@Test
	public void ToverifyCreatedActivityEdited() throws Exception {
		if (!(CommonMethods.isTestRunnable("TC09_ToverifyCreatedActivityToBeEditedTest"))) {
			  
			  throw new SkipException("Skipping the test " + "To verify Created Activity To Be Edited".toUpperCase() + "as the Run mode is NO"); 
		...
		// Edit Appointment
		retailAppointmentPage.editAppointment(sheetname);
		Thread.sleep(2000);
